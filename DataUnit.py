    ...
    def h1(self, x, y):
        ...
        for index in range(len(x)):
            ...
            for i in range(this_x.shape[1]-1):
                for j in range(this_x.shape[1]-1):
                    if i != j:
                        ...
                        data_i['a_{}'.format(i), "a_columns_{}".format(i), 'a_{}'.format(j)].edge_index = edge_index
            
            data_edge_a_b = []
            for i in range(this_x.shape[0]):
                for j in range(this_x.shape[1] - 1):
                    data_edge_a_b.append([j, i])
            ...
            for i in range(this_x.shape[0]):
                ...
                data_i['a_{}'.format(i), "a_rows_{}".format(i), 'a_{}'.format(i)].edge_index = edge_index
